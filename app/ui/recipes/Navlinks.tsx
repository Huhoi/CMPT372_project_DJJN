...
const links = [
  { name: 'Recipes', href: '/pages/recipes', icon: QueueListIcon },
  { name: 'Inventory', href: '/pages/inventory', icon: CircleStackIcon },
  { name: 'Community', href: '/pages/community', icon: UserGroupIcon },
];
